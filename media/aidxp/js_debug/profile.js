function draw(plotclass, plotid) {
 ...
 d3.json("/debug/explore/profile/" + pageid + "/" + plotclass + "/" + plotid + "/", function(error, data) {
  ...
  svg.append("g")
      ...
      .call(xAxis.tickPadding(height - y(0)))
    .append("text")
      .attr("class", "label")
      .attr("x", width / 2)
      .attr("y", (height - y(0)) + 40)
 ...
 if(plotclass == "bipartite") {
  ...
  $("div#question-text").html("How does " + pagename + " relate to all " + plotid + "? <button class='alignright' onclick='toggleShareDiv();'>Share</button><span id='sharelink' onclick='selectText(\"sharelink\")'>http://aidxp.atlas.cid.harvard.edu/explore/static/profile/" + pageid + "/consistency/" + plotid + "/</span>");
 }
}
...
function toggleRankType(caller, type) {
  ...
  */
  ...
  d3.json("/explore/profile/" + pageid + "/bipartite_rank/" + type + "/", function(error, data) {
    ...
    $("div#question-text").html("What are the " + type + " most related to " + pagename + "? <button class='alignright' onclick='toggleShareDiv();'>Share</button><span id='sharelink' onclick='selectText(\"sharelink\")'>http://aidxp.atlas.cid.harvard.edu/explore/static/profile/" + pageid + "/bipartite_rank/" + plotid + "/</span>");
