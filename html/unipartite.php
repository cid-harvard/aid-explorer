    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $("select#country").change(function(){
          $("div#concernactivityrca").load("php/load_country_synergyplots.php", "country=" + $("select#country option:selected").val());
        });
      });
    </script>
  </head>
  <body>
   <div class="wrapper">
    ...
    <div class="content home">
      <div id="menu-left">
        <div class="here-left">Country</div>
...
<script>
 function loadplot_1() {
   $.get("php/load_plot_synergy.php?subject=" + $("select#country option:selected").val() + "&type=country_issue", function(data){
 ...
 function loadplot_2() {
   $.get("php/load_plot_synergy.php?subject=" + $("select#country option:selected").val() + "&type=country_org", function(data){
      var plotDataJSON = jQuery.parseJSON(data);
      $("#plot-2").html('');
      /* Sizing and scales. */
      var w = 400,
