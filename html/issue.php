    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $("select#country").change(function(){
          $("div#concernactivityrca").load("php/load_conceractivityrcalist_from_country.php", "country=" + $("select#country option:selected").val());
        });
      });
    </script>
  </head>
   ...
   <div class="wrapper">
    ...
    <div class="content home">
      <div id="menu-left">
        ...
        <a href="institution.php">Organization</a>
        <div class="here-left">Issue</div>
      </div>
      <div id="content-right">
        <form name="countryform" onsubmit="return false;">
          ...
          <td>
            ...
            <?
            $handle = @fopen("files/issue_list", "r");
...
<script>
 function loadplot_1() {
   $.get("php/load_plot_synergy.php?subject=" + $("select#country option:selected").val() + "&type=issue_org", function(data){
 ...
 function loadplot_2() {
   $.get("php/load_plot_synergy.php?subject=" + $("select#country option:selected").val() + "&type=issue_country", function(data){
      var plotDataJSON = jQuery.parseJSON(data);
      $("#plot-2").html('');
      /* Sizing and scales. */
      var w = 400,
 ...
 $("select#country").change(loadplots);
</script>
          </td>
          <tr>
