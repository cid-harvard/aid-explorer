...
for line in f:
   ...
   alpha[entity_id[fields[0]]][entity_id[fields[1]]] = float(fields[2])
   alpha[entity_id[fields[1]]][entity_id[fields[0]]] = float(fields[2])
   beta[entity_id[fields[0]]][entity_id[fields[1]]] = float(fields[3])
   beta[entity_id[fields[1]]][entity_id[fields[0]]] = float(fields[3])
f.close()
...
for line in f:
   fields = line.strip().split('\t')
   hits[entity_id[fields[0]]][entity_id[fields[1]]] = int(fields[2])
   hits[entity_id[fields[1]]][entity_id[fields[0]]] = int(fields[2])
   rca[entity_id[fields[0]]][entity_id[fields[1]]] = float(fields[3])
   rca[entity_id[fields[1]]][entity_id[fields[0]]] = float(fields[3])
f.close()
